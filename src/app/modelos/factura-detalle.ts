...
export class FacturaDetalle {
  ...
  private calcular_valor_descuento_subtotales(factura: Factura){
    if (this.impuesto.porcentaje>0){
      this.valor_descuento_individual_subtotales=((Number(factura.valor_descuento_subtotal)*this.total_sin_descuento)/factura.subtotal_sin_descuento)/((100+this.impuesto.porcentaje)/100);
    } else{
  ...
  private calcular_valor_porcentaje_descuento_subtotales(factura: Factura){
    if (this.impuesto.porcentaje>0){
      this.valor_porcentaje_descuento_individual_subtotales=((factura.valor_porcentaje_descuento_subtotal*this.total_sin_descuento)/factura.subtotal_sin_descuento)/((100+this.impuesto.porcentaje)/100);
    } else {
  ...
  private calcular_valor_descuento_totales(factura: Factura){
    if (this.impuesto.porcentaje>0){
      this.valor_descuento_individual_totales=((Number(factura.valor_descuento_total)*this.total_sin_descuento)/factura.total_sin_descuento)/((100+this.impuesto.porcentaje)/100);
    } else{
      this.valor_descuento_individual_totales=((Number(factura.valor_descuento_total)*this.total_sin_descuento)/factura.total_sin_descuento);
    }
  ...
  private calcular_valor_porcentaje_descuento_totales(factura: Factura){
    if (this.impuesto.porcentaje>0){
      this.valor_porcentaje_descuento_individual_totales=((factura.valor_porcentaje_descuento_total*this.total_sin_descuento)/factura.total_sin_descuento)/((100+this.impuesto.porcentaje)/100);
    } else {
      this.valor_porcentaje_descuento_individual_totales=((factura.valor_porcentaje_descuento_total*this.total_sin_descuento)/factura.total_sin_descuento);
    }
