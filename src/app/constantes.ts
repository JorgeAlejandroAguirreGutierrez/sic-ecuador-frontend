...
export const item_crear_categoria_cliente='Crear Categoria Cliente';
export const item_crear_celular='Crear Celular';
export const item_crear_cliente='Gestionar Clientes';
export const item_crear_correo='Crear Correo';
export const item_crear_direccion='Crear Direccion';
export const item_crear_estado_civil='Crear Estado Civil';
export const item_crear_forma_pago='Crear Forma de Pago';
export const item_crear_genero='Crear Genero';
export const item_crear_grupo_cliente='Crear Grupo para Clientes';
export const item_crear_impuesto='Crear Impuesto';
export const item_crear_origen_ingreso='Crear Origen de Ingreso';
export const item_crear_plazo_credito='Crear Plazo de Credito';
...
export const item_crear_tipo_pago='Crear Tipo de Pago';
...
export const item_crear_medida='Crear Medida';
export const item_crear_producto='Crear Producto';
export const item_crear_promocion='Crear Promocion';
export const item_crear_saldo_inicial_inventario='Crear SII';
export const item_crear_tabla_equivalencia_medida='Crear TEM';
...
export const item_buscar_cliente='Buscar Cliente';
...
export const ico_crear_medida=          'fa fa-file-text-o';
export const ico_crear_producto=        'fa fa-file-text-o';
export const ico_crear_promocion=       'fa fa-file-text-o';
export const ico_crear_saldo_inicial_inventario='fa fa-file-text-o';
export const ico_crear_tabla_equivalencia_medida='fa fa-file-text-o';
...
export const ico_crear_grupo_producto=  'fa fa-file-text-o';
...
export const ico_buscar_producto=       'fa fa-file-text-o';
...
export const ico_promociones = 'fa fa-file-text-o';
